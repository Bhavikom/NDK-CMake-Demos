...
import com.catalinagroup.callrecorder.p117h.C1580f;
...
import com.catalinagroup.callrecorder.service.recorders.other.C1533a;
...
public class C1801j {
        ...
        class C1804b implements OnClickListener {
            ...
            *//* renamed from: c *//*
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                String[] aVarArr = (String[]) arrayList.toArray(new String[arrayList.size()]);
                C1802a aVar = C1802a.this;
                C1801j.m8070b(aVar.f5415e, aVarArr, aVar.f5416f, aVar.f5417g);
            }
        }

        C1802a(boolean z, String[] aVarArr, Context context, C1808c cVar, Runnable runnable) {
            this.f5413c = z;
            this.f5414d = aVarArr;
            this.f5415e = context;
            this.f5416f = cVar;
    ...
    *//* renamed from: k *//*
    ...
    private static String m8048a(Context context, Set<String> set, String str, String str2) {
        String str3 = Context.TELEPHONY_SERVICE;
        if (str3.equals(str)) {
            for (String str4 : set) {
    ...
    /* renamed from: b */
    /*public static void m8070b(Context context, String[] aVarArr, C1808c cVar, Runnable runnable) {
        if (cVar != null) {
    ...
    /* renamed from: a */
    /*public static void m8061a(Context context, String[] aVarArr, boolean z, C1808c cVar, Runnable runnable) {
        String str;
        if (aVarArr.length > 1) {
